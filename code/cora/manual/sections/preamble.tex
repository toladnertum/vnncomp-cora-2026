...
% avoid page breaks in footnotes
...
\usepackage{fontawesome5} % nice symbols
...
\usepackage[nn,colors,tikz]{cora-macs}

% tikz - special libraries
...
\newcommand{\textttsmall}[1]{{\small{\texttt{#1}}}}
