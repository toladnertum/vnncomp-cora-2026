...
\begin{equation*}
    \texttt{HA} = \texttt{hybridAutomaton}(\mathbf{L}),
\end{equation*}
where $\mathbf{L} = (L_1,\dots,L_p)$ is a list of location objects represented as an array of \texttt{location} objects (see \eqref{eq:location}).
