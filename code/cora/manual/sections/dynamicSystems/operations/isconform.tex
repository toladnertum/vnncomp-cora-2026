...
\begin{equation*}
\begin{split}
    & [\texttt{res}, \texttt{R}, \texttt{traj}, \texttt{unifiedOutputs}] = \texttt{isconform}(\texttt{sys},\texttt{params},\texttt{options},\texttt{type})
\end{split}
\end{equation*}
...
\begin{tabular}[t]{l p{13cm} }
	...
	$\bullet$~\texttt{traj} & object of class \texttt{trajectory} (see \cref{sec:trajectory}) that stores simulated trajectories in case a white-box model is used for reachset conformance. \\
