...
\subsubsubsection{contains} \label{sec:contains}
...
\begin{minipage}[t]{0.40\textwidth}
	\vspace{10pt}
	\footnotesize
	\input{./MATLABcode/example_contains}
\end{minipage}
...
For certain set representations, the method $\operator{contains}$ also admits additional input and output options:
\begin{verbatim}
[res, cert, scaling] = contains(S1, S2, method, tol, maxEval);
\end{verbatim}
The optional argument \verb|method| specifies which algorithm should be used to solve the containment problem. Apart from \verb|'exact'| and \verb|'approx'|, some set representations have a sampling-based algorithm (see e.g., \cite{Kulmburg2024}) that can be called using the option \verb|method = 'sampling'|, or an optimization-based algorithm (see \cite{Kulmburg2021}) that can be called using the option \verb|method = 'opt'|. Some set representations also have special sub-algorithms. For instance, the zonotope-in-zonotope containment problem admits two approximative algorithms, \verb|approx:st| and\newline\verb|approx:stDual|. We refer to the corresponding function file for more details on available algorithms.

The optional argument \verb|tol| indicates the tolerance for the containment check: the higher the tolerance, the more likely it is that points near the boundary of \verb|S1| will be detected as lying in \verb|S1|, which can be useful to counteract errors originating from floating point errors.

The optional argument \verb|maxEval| is used for sampling- or optimization-based algorithms, and indicates the maximum number of steps that the algorithm should perform.

The output \verb|cert| is set to \verb|true| if and only if the result of \verb|res| could be verified. This is particularly useful for approximative algorithms, as it allows to distinguish between cases where the algorithm either confirms containment (in which case \verb|res = true| and \verb|cert = true|), disproves containment (in which case \verb|res = false| and \verb|cert = true|), or fails to confirm or disprove containment (in which case \verb|res| can be arbitrary, but \verb|cert = false|). Specifically, if \verb|cert = false|, the set \verb|S_2| might still be contained in \verb|S_1| even if \verb|res = false|.

Finally, the output \verb|scaling| is the minimal scalar such that
$$\verb|S_2| \subseteq \verb|center(S_1) + scaling * (S_1 - center(S_1))|.$$
The method \operator{enlarge} (\cref{sec:enlarge}) computes this scaling in CORA.
Please note that \verb|scaling| is infinite if the subset relation above cannot be established.
...
\begin{table}[htb]
	...
	\begin{tabular}{ l c c c c c c c c c c c c}
		\toprule
					 & \textbf{I} & \textbf{Z} & \textbf{P} & \textbf{cZ} & \textbf{zB} & \textbf{E} & \textbf{C} & \textbf{pZ} & \textbf{cPZ} & \textbf{levelSet} & \textbf{SpS}\\
		\midrule
		\textbf{interval} (I)       		  & e & e/o & e & e/o & e/o & e	& e & o & o & o & o\\
		\textbf{zonotope} (Z)      		    & e & e/o & e & e/o & e/o & e	& e & o & o & o & o\\
		\textbf{polytope} (P)   	        & e & e/o & e & e/o & e/o & e	& e & o & o & o & o\\
		\textbf{conZonotope} (cZ)		      & e & e/o & e & e/o & e/o & e	& e & o & o & o & o\\
		\textbf{zonoBundle} (zB)  	      	  & e & e/o & e & e/o & e/o & e	& e & o & o & o & o\\
		\textbf{ellipsoid} (E)       	      & e & e   & e & e   & e   & e & o & o & o & o & o\\
		\textbf{capsule} (C)				  & e & e   & e & e   & e   & o	& e & o & o & o & o\\
		\textbf{polyZonotope} (pZ)		 	  & o & o   & o & o   & o   & o	& o & o & o & o & o\\
		\textbf{conPolyZono} (cPZ)			  & o & o   & o & o   & o   & o	& o & o & o & o & o\\
		\textbf{taylm}     	                  & o & o   & o & o   & o   & o	& o & o & o & o & o\\
		\textbf{spectraShadow} (SpS)		  & e & e   & e & e   & e   & o & o & o & o & o & o\\
		\bottomrule
	\end{tabular}
\end{table}
