...
% Last update:   11-June-2026 (BK, enabled supported benchmarks)
% Last revision: ---
...
benchmarks = {...
    ...
    'cersyve', ...
    'cgan_2023', ... % (transformer models rejected as not supported)
    'cgan2026', ... % (transformer models rejected as not supported)
